...
def parse_args():
    ...
    parser.add_argument("--gt_scene_dir", type=str, default="/scratch/joanna_cheng/scannet_gt/val")
    parser.add_argument("--gs_root", type=str, default="/scratch/joanna_cheng/scannet_3dgs")
    # parser.add_argument("--label_path", type=str, default="/scratch/joanna_cheng/scannetpp_v1_val_subset/scannetpp_semseg_top100.txt")
    parser.add_argument("--label20_path", type=str, default="/scratch/joanna_cheng/scannet_interval/scannet_label20.txt")
    parser.add_argument("--label200_path", type=str, default="/scratch/joanna_cheng/scannet_interval/scannet_label200.txt")
